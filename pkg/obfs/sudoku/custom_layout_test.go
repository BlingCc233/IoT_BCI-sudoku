...
func TestCustomLayoutParsingAndPadding(t *testing.T) {
	table, err := NewTableWithCustom("seed-custom", "prefer_entropy", "xppppxvv")
	if err != nil {
...
func TestCustomLayoutAsciiPriority(t *testing.T) {
	table, err := NewTableWithCustom("seed-custom", "prefer_ascii", "xppppxvv")
	if err != nil {
...
func TestCustomLayoutConnRoundTrip(t *testing.T) {
	table, err := NewTableWithCustom("roundtrip", "prefer_entropy", "xppppxvv")
	if err != nil {
...
func TestCustomLayoutPackedRoundTrip(t *testing.T) {
	table, err := NewTableWithCustom("packed-roundtrip", "prefer_entropy", "xppppxvv")
	if err != nil {
		t.Fatalf("table creation failed: %v", err)
	}
...
func TestCustomLayoutInvalidPatterns(t *testing.T) {
	if _, err := NewTableWithCustom("seed", "prefer_entropy", "xxxxppvv"); err == nil {
		t.Fatalf("expected error for invalid pattern")
	}
	if _, err := NewTableWithCustom("seed", "badmode", "xppppxvv"); err == nil {
		t.Fatalf("expected error for invalid ascii mode")
	}
}

func TestCustomLayoutPackedStress(t *testing.T) {
	table, err := NewTableWithCustom("stress-key", "prefer_entropy", "vppxppvx")
	if err != nil {
		t.Fatalf("table creation failed: %v", err)
	}
