...
因此，组合数独协议在 BCI-IoT 场景下可视为兼顾安全语义、资源约束与外观调控能力的可部署方案：相较 Pure-AEAD，安全语义更完整；相较 MQTT/DTLS，内存占用更低且外观对抗能力更强；代价是 pure 路径开销较高、标准化生态仍需扩展（见表~\ref{tab:c4-cross-region-main}、图~\ref{fig:c4-sidechannel-dpi}、表~\ref{tab:c4-security-evidence}）。
